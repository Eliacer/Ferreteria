                ...
                <tr>
                    ...
                    <td class="head" width="60%">
                        <table align="center" class="alinear">
                            <tr>
                                <td colspan="2" align="center"><b><em>Sistema de cafetín</em></b></td>
                            </tr>
                            <tr>
                                <td valign="top">
                                ...
                                <td>
                                    <s:form name="form" action="Logeo" method="post" >
                                        <s:textfield name="SGusuario.usuario" maxLength="25" label="Usuario" size="20"/>
                                        <s:password name="SGusuario.clave" maxLength="25" label="Clave" size="20"/>
                                        <s:submit name="ingresar" value="Ingresar" align="center" title="Ingresar"/>
                                    </s:form>
                                    <div class="error_login"><s:property value="msg"/></div>
                                </td>
